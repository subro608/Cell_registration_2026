...
N_RESOLUTIONS = 4
MAX_ITER = 2000
ITER_CHECKPOINTS = [10, 50, 100, 200, 300, 500, 750, 1000, 1500, 2000]
...
out_dir = f'{BASE}/png_exports/z_stitch_elastix_highiter'
...
# Save results JSON
with open(f'{out_dir}/elastix_results_highiter.json', 'w') as f:
    json.dump(all_results, f, indent=2)
print(f"Results saved: {out_dir}/elastix_results_highiter.json")
