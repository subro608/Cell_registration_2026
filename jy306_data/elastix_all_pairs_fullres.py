...
# Elastix params — FULL RESOLUTION (DS=1, no downsampling)
DS = 1
GRID_SPACING = 32       # B-spline control point spacing (pixels, full resolution)
N_RESOLUTIONS = 4
MAX_ITER = 4000
ITER_CHECKPOINTS = [10, 50, 100, 200, 500, 1000, 1500, 2000, 3000, 4000]
...
out_dir = f'{BASE}/png_exports/z_stitch_elastix_fullres_4000iter'
...
# Save results JSON
with open(f'{out_dir}/elastix_results_fullres_4000iter.json', 'w') as f:
    json.dump(all_results, f, indent=2)
print(f"Results saved: {out_dir}/elastix_results_fullres_4000iter.json")
