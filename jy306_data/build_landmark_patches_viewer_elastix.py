...
OUT_HTML = f'{OUT_DIR}/landmark_patches_elastix.html'
...
<html>
<head>
<title>Landmark Patches — Ex-vivo vs In-vivo (Elastix)</title>
<style>
...
<body>
<h1>Landmark Patches: Ex-vivo vs In-vivo (Elastix corrected)</h1>
<div class="controls">
  <label>Tile:</label>
