...
Output: animation/scene5b_preview_h264.mp4 (quick preview with downsampled assets)
"""

import numpy as np, cv2, math, subprocess, os

BASE = '/Users/neurolab/neuroinformatics/margaret'
TMP  = f'{BASE}/animation/scene5b_preview_raw.mp4'
OUT  = f'{BASE}/animation/scene5b_preview_h264.mp4'
...
# ═══════════════════════════════════════════════════════════
# PHASE 1: Last frame of scenes_1_to_5 -> centered overlay (2.5s = 60 frames)
# Smooth crossfade from the final scene5 overlay to a centered mid-slice
# ═══════════════════════════════════════════════════════════
print("Phase 1: crossfade from scenes_1_to_5 last frame (2.5s)...")
...
for fi in range(60):
    t = ease(fi / 50)
    frame = cv2.addWeighted(last_frame, 1 - t, mid_centered, t, 0)
    # Fade out old caption, fade in new
    a_old = 1 - ease(fi / 20)
    a_new = ease((fi - 25) / 25)
...
# ═══════════════════════════════════════════════════════════
# PHASE 2: Hold centered overlay briefly (1s = 24 frames)
# Let viewer absorb the stitched result before 3D
# ═══════════════════════════════════════════════════════════
print("Phase 2: hold centered overlay (1s)...")
...
# ═══════════════════════════════════════════════════════════
# PHASE 3: Slices emerge + tilt (2.5s = 60 frames)
# Smoothly spread slices from flat to 3D
# ═══════════════════════════════════════════════════════════
print("Phase 3: slices emerge (2.5s)...")

for fi in range(60):
    t = ease(fi / 50)

    # All slices progressively appear from center outward
...
# ═══════════════════════════════════════════════════════════
# PHASE 4: 3D rotation (6s = 144 frames)
# ═══════════════════════════════════════════════════════════
print("Phase 4: 3D rotation (6s)...")
...
# ═══════════════════════════════════════════════════════════
# PHASE 5: Settle front-facing (1.5s = 36 frames)
# ═══════════════════════════════════════════════════════════
print("Phase 5: settle (1.5s)...")
...
# ═══════════════════════════════════════════════════════════
# PHASE 6: Hold (1.5s = 36 frames)
# ═══════════════════════════════════════════════════════════
print("Phase 6: hold (1.5s)...")
